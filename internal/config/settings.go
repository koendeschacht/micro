...
var optionValidators = map[string]optionValidator{
	...
	"errormessagetimeout": validateNonNegativeValue,
	"fileformat":          validateChoice,
	"helpsplit":           validateChoice,
	"infomessagetimeout":  validateNonNegativeValue,
	"keysequencetimeout":  validateNonNegativeValue,
...
var DefaultGlobalOnlySettings = map[string]any{
	...
	"divchars":            "|-",
	"divreverse":          true,
	"errormessagetimeout": float64(10),
	"fakecursor":          defaultFakeCursor(),
	"helpsplit":           "hsplit",
	"infobar":             true,
	"infomessagetimeout":  float64(2),
	"keysequencetimeout":  float64(1000),
	"keymenu":             false,
	"leader":              "Ctrl-k",
	"lockbindings":        false,
	"mouse":               true,
